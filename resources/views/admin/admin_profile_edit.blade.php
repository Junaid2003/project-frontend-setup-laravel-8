			...
			@csrf
					  <div class="row">
                        ...
                        <div class="col-md-6">               
							...
							<div class="col-md-6">
							<img id="showImage" src="{{ (!empty($editData->profile_photo_path))? url('upload/admin_images/'.$editData->profile_photo_path):url('upload/Junaid.jpg') }}" alt="" style="width: 100px; height: 100px;">
							</div> <!-- end of col-md-6 -->
