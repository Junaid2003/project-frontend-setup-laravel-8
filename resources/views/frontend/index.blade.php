        ...
        <div class="sidebar-widget hot-deals wow fadeInUp outer-bottom-xs">
          ...
          <div class="owl-carousel sidebar-carousel custom-carousel owl-theme outer-top-ss">
            <div class="item">
              <div class="products">
                <div class="hot-deal-wrapper">
                  <div class="image"> <img src="{{ ('frontend/assets/images/hot-deals/p25.jpg') }}" alt=""> </div>
            ...
            <div class="item">
              <div class="products">
                <div class="hot-deal-wrapper">
                  <div class="image"> <img src="{{ ('frontend/assets/images/hot-deals/p5.jpg') }}" alt=""> </div>
            ...
            <div class="item">
              <div class="products">
                <div class="hot-deal-wrapper">
                  <div class="image"> <img src="{{ ('frontend/assets/images/hot-deals/p10.jpg') }}" alt=""> </div>
                  <div class="sale-offer-tag"><span>35%<br>
                    off</span></div>
                  <div class="timing-wrapper">
                    <div class="box-wrapper">
                  ...
                  <div class="product">
                    <div class="product-micro">
                      <div class="row product-micro-row">
                        <div class="col col-xs-5">
                          <div class="product-image">
                            <div class="image"> <a href="#"> <img src="{{ ('frontend/assets/images/products/p29.jpg') }}" alt=""> </a> </div>
                            <!-- /.image --> 
                  ...
                  <div class="product">
                    <div class="product-micro">
                      <div class="row product-micro-row">
                        <div class="col col-xs-5">
                          <div class="product-image">
                            <div class="image"> <a href="#"> <img src="{{ ('frontend/assets/images/products/p28.jpg') }}" alt=""> </a> </div>
                            <!-- /.image --> 
                  ...
                  <div class="product">
                    <div class="product-micro">
                      <div class="row product-micro-row">
                        <div class="col col-xs-5">
                          <div class="product-image">
                            <div class="image"> <a href="#"> <img src="{{ ('frontend/assets/images/products/p15.jpg') }}"  alt=""> </a> </div>
                            <!-- /.image --> 
                  ...
                  <div class="product">
                    <div class="product-micro">
                      <div class="row product-micro-row">
                        <div class="col col-xs-5">
                          <div class="product-image">
                            <div class="image"> <a href="#"> <img src="{{ ('frontend/assets/images/products/p26.jpg') }}"  alt="image"> </a> </div>
                            <!-- /.image --> 
                  ...
                  <div class="product">
                    <div class="product-micro">
                      <div class="row product-micro-row">
                        <div class="col col-xs-5">
                          <div class="product-image">
                            <div class="image"> <a href="#"> <img src="{{ ('frontend/assets/images/products/p18.jpg') }}" alt=""> </a> </div>
                            <!-- /.image --> 
                  ...
                  <div class="product">
                    <div class="product-micro">
                      <div class="row product-micro-row">
                        <div class="col col-xs-5">
                          <div class="product-image">
                            <div class="image"> <a href="#"> <img src="{{ ('frontend/assets/images/products/p17.jpg') }}" alt=""> </a> </div>
                            <!-- /.image --> 
                  ...
                  <div class="product">
                    <div class="product-micro">
                      <div class="row product-micro-row">
                        <div class="col col-xs-5">
                          <div class="product-image">
                            <div class="image"> <a href="#"> <img src="{{ ('frontend/assets/images/products/p16.jpg') }}" alt=""> </a> </div>
                            <!-- /.image --> 
                  ...
                  <div class="product">
                    <div class="product-micro">
                      <div class="row product-micro-row">
                        <div class="col col-xs-5">
                          <div class="product-image">
                            <div class="image"> <a href="#"> <img src="{{ ('frontend/assets/images/products/p15.jpg') }}" alt="images">
                  ...
                  <div class="product">
                    <div class="product-micro">
                      <div class="row product-micro-row">
                        <div class="col col-xs-5">
                          <div class="product-image">
                            <div class="image"> <a href="#"> <img src="{{ ('frontend/assets/images/products/p14.jpg') }}"  alt="">
                              <div class="zoom-overlay"></div>
                              </a> </div>
                            <!-- /.image --> 
                  ...
                  <div class="product">
                    <div class="product-micro">
                      <div class="row product-micro-row">
                        <div class="col col-xs-5">
                          <div class="product-image">
                            <div class="image"> <a href="#"> <img src="{{ ('frontend/assets/images/products/p13.jpg') }}" alt="image"> </a> </div>
                            <!-- /.image --> 
                ...
                <div class="owl-carousel home-owl-carousel custom-carousel owl-theme" data-item="4">
                  ...
                  <div class="item item-carousel">
                    <div class="products">
                      <div class="product">
                        <div class="product-image">
                          <div class="image"> <a href="detail.html"><img  src="{{ ('frontend/assets/images/products/p4.jpg') }}" alt=""></a> </div>
                          <!-- /.image -->
                  ...
                  <div class="item item-carousel">
                    <div class="products">
                      <div class="product">
                        <div class="product-image">
                          <div class="image"> <a href="detail.html"><img  src="{{ ('frontend/assets/images/products/p29.jpg') }}" alt=""></a> </div>
                          <!-- /.image -->
                ...
                <div class="owl-carousel home-owl-carousel custom-carousel owl-theme">
                  ...
                  <div class="item item-carousel">
                    <div class="products">
                      <div class="product">
                        <div class="product-image">
                          <div class="image"> <a href="detail.html"><img  src="{{ ('frontend/assets/images/products/p7.jpg') }}" alt=""></a> </div>
                          <!-- /.image -->
                  ...
                  <div class="item item-carousel">
                    <div class="products">
                      <div class="product">
                        <div class="product-image">
                          <div class="image"> <a href="detail.html"><img  src="{{ ('frontend/assets/images/products/p8.jpg') }}" alt=""></a> </div>
                          <!-- /.image -->
                  ...
                  <div class="item item-carousel">
                    <div class="products">
                      <div class="product">
                        <div class="product-image">
                          <div class="image"> <a href="detail.html"><img  src="{{ ('frontend/assets/images/products/p9.jpg') }}" alt=""></a> </div>
                          <!-- /.image -->
                ...
                <div class="owl-carousel home-owl-carousel custom-carousel owl-theme">
                  <div class="item item-carousel">
                    <div class="products">
                      <div class="product">
                        <div class="product-image">
                          <div class="image"> <a href="detail.html"><img  src="{{ ('frontend/assets/images/products/p11.jpg') }}" alt=""></a> </div>
                          <!-- /.image -->
                  ...
                  <div class="item item-carousel">
                    <div class="products">
                      <div class="product">
                        <div class="product-image">
                          <div class="image"> <a href="detail.html"><img  src="{{ ('frontend/assets/images/products/p12.jpg') }}" alt=""></a> </div>
                          <!-- /.image -->
                  ...
                  <div class="item item-carousel">
                    <div class="products">
                      <div class="product">
                        <div class="product-image">
                          <div class="image"> <a href="detail.html"><img  src="{{ ('frontend/assets/images/products/p13.jpg') }}" alt=""></a> </div>
                          <!-- /.image -->
                  ...
                  <div class="item item-carousel">
                    <div class="products">
                      <div class="product">
                        <div class="product-image">
                          <div class="image"> <a href="detail.html"><img src="{{ ('frontend/assets/images/products/p14.jpg') }}" alt=""></a> </div>
                          <!-- /.image -->
                  ...
                  <div class="item item-carousel">
                    <div class="products">
                      <div class="product">
                        <div class="product-image">
                          <div class="image"> <a href="detail.html"><img  src="{{ ('frontend/assets/images/products/p15.jpg') }}" alt="image"></a> </div>
                          <!-- /.image -->
                  ...
                  <div class="item item-carousel">
                    <div class="products">
                      <div class="product">
                        <div class="product-image">
                          <div class="image"> <a href="detail.html"><img src="{{ ('frontend/assets/images/products/p16.jpg') }}" alt=""></a> </div>
                          <!-- /.image -->
                ...
                <div class="owl-carousel home-owl-carousel custom-carousel owl-theme">
                  <div class="item item-carousel">
                    <div class="products">
                      <div class="product">
                        <div class="product-image">
                          <div class="image"> <a href="detail.html"><img src="{{ ('frontend/assets/images/products/p18.jpg') }}" alt=""></a> </div>
                          <!-- /.image -->
                  ...
                  <div class="item item-carousel">
                    <div class="products">
                      <div class="product">
                        <div class="product-image">
                          <div class="image"> <a href="detail.html"><img  src="{{ ('frontend/assets/images/products/p17.jpg') }}" alt=""></a> </div>
                          <!-- /.image -->
          ...
          <div class="owl-carousel home-owl-carousel custom-carousel owl-theme outer-top-xs">
            ...
            <div class="item item-carousel">
              <div class="products">
                <div class="product">
                  <div class="product-image">
                    <div class="image"> <a href="detail.html"><img  src="{{ ('frontend/assets/images/blank.gif') }}" data-echo="frontend/assets/images/products/p7.jpg" alt=""></a> </div>
                    <!-- /.image -->
